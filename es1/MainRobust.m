...
for t = 0:deltat:end_time
    ...
    % se vuoi aggiungere qualcosa devi farlo durante l'init perchè nel loop
    ...
    %disturbo ho qualche movimento oscillatorio nella simulazione
