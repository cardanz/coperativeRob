...
uvms.targetDistance = uvms.goalPosition(1:3) - uvms.p(1:3);
uvms.JtargetDistance = [zeros(1,7) -(1/norm(uvms.targetDistance)) * [uvms.targetDistance]' * uvms.wTv(1:3, 1:3) zeros(1,3)];
